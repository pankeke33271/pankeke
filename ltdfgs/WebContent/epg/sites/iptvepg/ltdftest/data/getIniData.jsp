...
uri = uri.replace("data/getIniData.jsp","");
realPath += uri;

String staticDataPath = readPropConfig("static.data.path",realPath);
System.out.println(staticDataPath);
if(staticDataPath == null || staticDataPath.isEmpty()){
	staticDataPath = realPath + "static-data/";
}
//System.out.println(staticDataPath);
...
if (null!=type && "d".equals(type.trim().toLowerCase())) { //全天校验
    iniFile = "ltdfgs_"+ new SimpleDateFormat("yyyy-MM-dd").format(currTimeMillis-24*60*60*1000).toString() +".txt";
    ...
    if (hour==3) {
        ...
        iniFile = "ltdfgs_"+ new SimpleDateFormat("yyyy-MM-dd_HH").format(currTimeMillis-60*60*1000).toString() +".txt";
    }
} else if (null!=type && "e".equals(type.trim().toLowerCase())) { //异常校验
    iniFile = "ltdfgs_"+ new SimpleDateFormat("yyyy-MM-dd").format(currTimeMillis-24*60*60*1000).toString() +"_e.txt";
} else {}
// iniFile = "ltdfgs_2020-11-25_e.txt"; //测试文件
// iniFile = "ltdfgs_2020-12-test.txt"; //测试文件
// iniFile = "ltdfgs_2021-03-11_23.txt"; //测试文件       
...
if (null!=iniFile) {
    ...
    //if (null==userId) {
        iniPath = staticDataPath + iniFile;
    //} else {
...
//out.print(rsMap);
//out.print("{\"TOTAL\":2, \"RSCODE\":0, \"FILESIZE\":346, \"RSDATA\":[{\"TYPES\":\"横图媒资测试/特别节目\", \"CODE\":\"00000021000000012021031102350157\", \"STATUS\":1, \"CPID\":\"00000021\", \"CPNAME\":\"广西广电新媒体\", \"NAME\":\"开启新征程 续写新辉煌——2021全国两会特别节目20210311\"}, {\"TYPES\":\"横图媒资测试/特别节目\", \"CODE\":\"00000021000000012021031002346929\", \"STATUS\":1, \"CPID\":\"00000021\", \"CPNAME\":\"广西广电新媒体\", \"NAME\":\"开启新征程 续写新辉煌——2021全国两会特别节目20210310\"}], \"RUNTIME\":2, \"INIFILE\":\"static-data/ltdfgs_2021-03-11_23.txt\", \"SYSTEMTIME\":1620360556790, \"USERID\":null, \"RSMSG\":\"success\", \"MODIFYTIME\":1620359447507}");
out.flush();
%>